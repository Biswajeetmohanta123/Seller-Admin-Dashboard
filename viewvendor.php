<?php
  session_start();
     ...
     {
      $uid=$_GET['id'];
      $query="delete from vendor_master where vendor_id='$uid'";
...
<?php
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Viewvendor</span>
                </div>
    ...
    <table>
      <thead>
          ...
          <?php
    $count=1;
    $sel_query="select * from vendor_master ORDER BY vendor_id asc;";
    ...
    ?>
       ...
       <td align="center"><?php echo $count;?></td>
            ...
            <td align="center"><?php echo $row['vendor_address'];?></td>
            <td align="center"><?php echo $row['vendor_email'];?></td>
            <td align="center"><?php echo $row['vendor_contact'];?></td>
            <td align="center"><?php echo $row['gst_type'];?></td>
            <td align="center">

            <a href="updatevendor.php?vid=<?php echo $row['vendor_id'];?>">
...
<a href="viewvendor.php?id=<?php echo $row['vendor_id'];?>">
